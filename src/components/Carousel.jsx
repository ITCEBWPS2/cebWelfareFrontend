...
const Carousel = () => {
  ...
  return (
    <div className="relative overflow-hidden items-center justify-center max-w-sm min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(${slides[current].image})` }}>
      ...
      <button onClick={nextSlide} className="absolute left-0 top-1/2 transform -translate-y-1/2 p-4 bg-gray-700 bg-opacity-50 hover:bg-opacity-75 text-white rounded-full cursor-pointer">
