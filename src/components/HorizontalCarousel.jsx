...
const HorizontalCarousel = () => {
  ...
  return (
    <div className="relative min-h-96 w-full overflow-hidden">
      ...
      <button onClick={() => setCurrent((current - 1 + slides.length) % slides.length)} className="absolute left-0 top-1/2 transform -translate-y-1/2 p-4 bg-gray-700 bg-opacity-50 hover:bg-opacity-75 text-white rounded-full">
